...
public class NameValidator implements Validator {
	...
	private final AdressValidator nextEditUserinfoValidator = AdressValidator.getInstance();
	...
	public String validate(UserInfo userPageInfo) {
		...
		String firstName = userPageInfo.getUserFirstName();
		String secondName = userPageInfo.getUserSecondName();
		String patronymic = userPageInfo.getUserPatronymic();
