...
<body>
	...
	<div class="main_user_info" style="float: rigth; position: related">
		...
		<table>
			...
			<tr>
				<td>Адрес:</td>
				<td><input type="text" name="userAdress" required
					value="${sessionScope.bean.userAdress}" /></td>
			</tr>
			<tr>
				<td>Дата рождения:</td>
				<td><input type="date" id="userDateOfBirth"
					name="userDateOfBirth" value="${sessionScope.bean.userDateOfBirth}" />
			</tr>
			<tr>
				<td>Номер телефона:</td>
				<td><input type="text" name="userPhone" required
		...
		<div align="center">
			<form action="Controller" method="post">
				<input type="hidden" name="command" value="edit_user_info" /> <input
					type="submit" value="Сохранить данные" /><br />
			</form>
		</div>
