...
<title><c:out value="${user_rating_page}" /></title>
...
<fmt:message bundle="${loc}" key="completed_courses"
	var="completed_courses" />
<fmt:message bundle="${loc}" key="no_courses_completed"
	var="no_courses_completed" />
...
<fmt:message bundle="${loc}" key="course_title" var="course_title" />
<fmt:message bundle="${loc}" key="user_rating_page"
	var="user_rating_page" />
...
<body>
	...
	<div class="inscription">
		<c:out value="${completed_courses}" />
	</div>
	<c:if test="${empty requestScope.student.studentMarks}">
		<div class="inscription">
			<c:out value="${no_courses_completed}" />
		</div>
	</c:if>
	<c:if test="${!empty requestScope.student.studentMarks}">
		<table>
			<tr>
				<th><c:out value="${course_title}" /></th>
